...
//No need to specify extension in NodeJS
    ...
    .then(authors => {
        books.forEach(book => {
            const author = authors.find(
                el => el.firstName === book.author.firstName && el.lastName === book.author.lastName
            )
            //Cleanest way of cloning an object
            //As an array because of our schema
